#include "aginika_pcl_ros/simple_mutable_model_tracking.h"
  ...
  void SimpleMutableModelTracking::octreeResultCb(const sensor_msgs::PointCloud2 &pc)
  {
    ...
    new_octree_result_cloud = true;
    {
      ...
      if (new_octree_result_cloud && new_track_model_cloud && new_input_cloud &&
        ...
        ros::ServiceClient client = pnh_->serviceClient<aginika_pcl_ros::SetPointCloud2>("/pcl_nodelet/particle_filter_tracker/renew_model");
...
typedef aginika_pcl_ros::SimpleMutableModelTracking SimpleMutableModelTracking;
PLUGINLIB_DECLARE_CLASS (aginika_pcl, SimpleMutableModelTracking, SimpleMutableModelTracking, nodelet::Nodelet);
