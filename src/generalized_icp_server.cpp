...
#include "aginika_pcl_ros/ICPAlign.h"
#include "aginika_pcl_ros/ICPAlignReturn.h"
...
bool ICPCallback(aginika_pcl_ros::ICPAlign::Request &req,
                 aginika_pcl_ros::ICPAlign::Response &res) {
...
bool ICPCloudCallback(aginika_pcl_ros::ICPAlignReturn::Request &req,
                 aginika_pcl_ros::ICPAlignReturn::Response &res) {
