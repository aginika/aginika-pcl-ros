...
clf = RandomForestClassifier(n_estimators=500, max_features=None, min_samples_split=1, random_state=0)
scores = cross_val_score(clf, np.array(data_x), np.array(data_y))
print "random foreset : "
print scores.mean()
